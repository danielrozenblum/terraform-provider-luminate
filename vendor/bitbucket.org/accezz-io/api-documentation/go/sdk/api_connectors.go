...
Creates a Connector in your Secure Access Cloud tenant. To complete configuring the Secure Access Cloud connector, you should retrieve the deployment command using &lt;a href&#x3D;\&quot;#operation/getConnectorCommand\&quot;&gt;Connector Deployment Command API&lt;/a&gt; and execute it on the target machine.
...
func (a *ConnectorsApiService) CreateConnector(ctx context.Context, bindToSiteId string, localVarOptionals *CreateConnectorOpts) (Connector, *http.Response, error) {
	var (
...
type GetAllConnectorsOpts struct {
...
func (a *ConnectorsApiService) GetAllConnectors(ctx context.Context, localVarOptionals *GetAllConnectorsOpts) (ConnectorsPage, *http.Response, error) {
	var (
...
func (a *ConnectorsApiService) GetConnectorEnvironmentVariables(ctx context.Context, connectorId string) (ConnectorEnvironmentVariables, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ConnectorEnvironmentVariables
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/connectors/{connector-id}/environment_variables"
	localVarPath = strings.Replace(localVarPath, "{"+"connector-id"+"}", fmt.Sprintf("%v", connectorId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConnectorEnvironmentVariables
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *ConnectorsApiService) GetConnectorVersion(ctx context.Context) (ConnectorVersion, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ConnectorVersion
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/connectors/version"
